 ...
 *
 * This interface defines methods for setting and retrieving key-value configuration
 * parameters. It is designed to be implemented as a singleton or injected dependency.
 */
class IConfig {
public:
    /**
